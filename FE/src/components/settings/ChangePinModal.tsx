  ...
  async function next() {
    switch (step) {
      ...
      case 2: {
        ...
        if (newPin === oldPin) {
          StatusModal.error("Invalid PIN", "Your new PIN must be different.");
          return;
        }
      ...
      case 3: {
        ...
        if (confirmPin !== newPin) {
          StatusModal.error("PIN Mismatch", "The PINs do not match.");
        ...
        StatusModal.success("Success", "PIN changed successfully.");
